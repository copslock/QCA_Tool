...
void* initEEPROMREADOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pEEPROMREADParms->bdSize = pParmDict[PARM_BDSIZE].v.valU32;
    pEEPROMREADParms->offset = pParmDict[PARM_OFFSET].v.valU32;
    pEEPROMREADParms->size = pParmDict[PARM_SIZE].v.valU32;

    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_BDSIZE, (A_UINT32)(((A_UINT32)&(pEEPROMREADParms->bdSize)) - (A_UINT32)pEEPROMREADParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("EEPROMREADOp: bdSize %u\n", pEEPROMREADParms->bdSize);

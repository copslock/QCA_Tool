...
void* initEEPROMGETSIZERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pEEPROMGETSIZERSPParms->bdSize = pParmDict[PARM_BDSIZE].v.valU32;
    ...
    fillParmOffsetTbl((A_UINT32)PARM_BDSIZE, (A_UINT32)(((A_UINT32)&(pEEPROMGETSIZERSPParms->bdSize)) - (A_UINT32)pEEPROMGETSIZERSPParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("EEPROMGETSIZERSPOp: bdSize %u\n", pEEPROMGETSIZERSPParms->bdSize);
#endif //_DEBUG

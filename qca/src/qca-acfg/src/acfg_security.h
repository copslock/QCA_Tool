...
#include <linux/un.h>
#define WPA_DRIVER_NL80211 "nl80211"
...
#define ACFG_SEC_CMP_OWE_TRANSITION_IFNAME(sec1, sec2) \
        strcmp(sec1.owe_transition_ifname, sec2.owe_transition_ifname)
#define ACFG_SEC_CMP_OWE_TRANSITION_SSID(sec1, sec2) \
        strcmp(sec1.owe_transition_ssid, sec2.owe_transition_ssid)
#define ACFG_SEC_CMP_OWE_TRANSITION_BSSID(sec1, sec2) \
        memcmp(sec1.owe_transition_bssid, sec2.owe_transition_bssid, ACFG_BSSID_ADDR_LEN)

...
int main(int argc , char *argv[])
{
    ...
    {	    
        ...
        {
            if (pPosition = strchr(argv[1], '=')) {
                if (strlen(pPosition+1) < sizeof(ipAddress))
                    memcpy(ipAddress, pPosition+1, (strlen(pPosition+1) + 1));
            }
        }

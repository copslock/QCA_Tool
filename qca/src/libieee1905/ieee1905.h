...
typedef enum ieee1905Event_e
{
    ...
    IEEE1905_EVENT_CHANNEL_SCAN,
    IEEE1905_EVENT_CAC,
    IEEE1905_EVENT_TUNNELED_MESSAGE,
    IEEE1905_EVENT_ASSOC_STATUS_NOTIFICATION_MESSAGE,
    IEEE1905_EVENT_BACKHAUL_STA_CAPABILITY,
    IEEE1905_EVENT_FAILED_CONNECTION,
 ...
 * IF VLAN is configured for MAP we can have upto 4 FrontHauls, 2 Backhauls,
 * 1 Smart monitor VAP, 1 bridge interface , 1 STA VAP and 6 ethernet GMACS
 * for 3 Radio  HK
 */
#define IEEE1905_MAX_INTERFACES 30

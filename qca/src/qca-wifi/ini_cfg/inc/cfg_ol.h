...
#define CFG_OL_SELF_NON_SRG_OBSS_PD_THRESHOLD \
	CFG_INI_UINT("self_non_srg_obss_pd_threshold", \
	0,1000,\
	IEEE80211_SELF_NON_SRG_OBSS_PD_THRESHOLD,\
	CFG_VALUE_OR_DEFAULT,"Self Non-SRG OBSS-PD Threshold")
...
#define CFG_OL_SELF_SRG_OBSS_PD_THRESHOLD \
	CFG_INI_UINT("self_srg_obss_pd_threshold", \
	0,1000,\
	IEEE80211_SELF_SRG_OBSS_PD_THRESHOLD,\
	CFG_VALUE_OR_DEFAULT,"Self SRG OBSS-PD Threshold")
...
#define CFG_OL_SRP_SRG_BSS_COLOR_BITMAP_HIGH \
	CFG_INI_UINT("srp_srg_bss_color_bitmap_high", \
	0,MAX_CFG, \
	IEEE80211_SRP_SRG_BSS_COLOR_BITMAP, \
	CFG_VALUE_OR_DEFAULT, "SRP SRG BSS Color Bitmap high 32bits")

#define CFG_OL_SRP_SRG_BSS_COLOR_BITMAP_LOW \
	CFG_INI_UINT("srp_srg_bss_color_bitmap_low", \
	0,MAX_CFG, \
	IEEE80211_SRP_SRG_BSS_COLOR_BITMAP, \
	CFG_VALUE_OR_DEFAULT, "SRP SRG BSS Color Bitmap low 32bits")

#define CFG_OL_SRP_SRG_PARTIAL_BSSID_BITMAP_HIGH \
	CFG_INI_UINT("srp_srg_partial_bssid_bitmap_high", \
	0,MAX_CFG, \
	IEEE80211_SRP_SRG_PARTIAL_BSSID_BITMAP, \
	CFG_VALUE_OR_DEFAULT, "SRP SRG BSSID Partial Bitmap high 32bits")

#define CFG_OL_SRP_SRG_PARTIAL_BSSID_BITMAP_LOW \
	CFG_INI_UINT("srp_srg_partial_bssid_bitmap_low", \
	0,MAX_CFG, \
	IEEE80211_SRP_SRG_PARTIAL_BSSID_BITMAP, \
	CFG_VALUE_OR_DEFAULT, "SRP SRG BSSID Partial Bitmap low 32bits")
...
#define CFG_OL \
	...
	CFG(CFG_OL_SELF_NON_SRG_OBSS_PD_THRESHOLD) \
	CFG(CFG_OL_SELF_NON_SRG_OBSS_PD_ENABLE) \
	CFG(CFG_OL_SELF_SRG_OBSS_PD_THRESHOLD) \

/*
 * Copyright (c) 2013, 2016-2020 Qualcomm Innovation Center, Inc.
 * All Rights Reserved.
...
qdf_export_symbol(ath_ahb_recover_2_0);
...
qdf_export_symbol(ahb_defer_reconnect_2_0);
...
int init_ath_ahb_2_0(void)
{
	...
	if(ret) {
		qdf_err("platform_driver_register failed %d",ret);
		return ret;
	}

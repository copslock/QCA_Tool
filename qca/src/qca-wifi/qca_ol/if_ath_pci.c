...
qdf_export_symbol(ath_pci_probe);
...
qdf_export_symbol(ath_pci_remove);
...
qdf_export_symbol(ath_pci_suspend);
...
qdf_export_symbol(ath_pci_resume);
#endif /* ATH_BUS_PM */

struct semaphore reset_in_progress;
bool driver_registered = false;
qdf_export_symbol(reset_in_progress);
qdf_export_symbol(driver_registered);

...
int ald_assoc_notify(wlan_if_t vap, u_int8_t *macaddr, u_int8_t aflag, u_int16_t reasonCode);
...
int ald_wnm_frame_recvd_notify(wlan_if_t vap, u_int8_t action, u_int8_t *macaddr, u_int8_t *frame,
                               u_int16_t frame_len);
int ald_anqp_frame_recvd_notify(wlan_if_t vap, u_int8_t *macaddr, u_int8_t *frame, u_int16_t frame_len);
...
#endif
#define ald_assoc_notify(a, b, c, d)    do{}while(0)
#define ald_buffull_notify(a)    do{}while(0)
#define ald_cbs_notify(a, b)   do{}while(0)
#define ald_acs_complete_notify(a)   do{}while(0)
#define ald_cac_complete_notify(a, b) do{}while(0)
#define ald_assoc_disallowed_notiy(a, b, c) do{}while(0)
#define ald_wnm_frame_recvd_notify(a, b, c, d, e) do{}while(0)
#define ald_anqp_frame_recvd_notify(a, b, c, d) do{}while(0)

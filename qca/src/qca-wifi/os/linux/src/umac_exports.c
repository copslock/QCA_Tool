...
qdf_export_symbol(ieee80211_ald_record_tx);
#endif
...
#endif
qdf_export_symbol(ieee80211_iterate_node);
...
qdf_export_symbol(ieee80211_crypto_newkey);
qdf_export_symbol(ieee80211_crypto_delkey);
qdf_export_symbol(ieee80211_crypto_setkey);
qdf_export_symbol(ieee80211_crypto_encap);
qdf_export_symbol(ieee80211_crypto_decap);
qdf_export_symbol(ieee80211_crypto_wep_setdummykey);

/* Export ieee80211_crypto_none.c functions */
qdf_export_symbol(ieee80211_cipher_none);

qdf_export_symbol(ieee80211_crypto_encap_mon);
#endif
...
qdf_export_symbol(ieee80211_measurement_report_action);
#endif
...
qdf_export_symbol(ieee80211_send_v_cv_action);
#endif
qdf_export_symbol(ieee80211_send_bar);
...
qdf_export_symbol(ieee80211_beacon_miss);
qdf_export_symbol(ieee80211_notify_beacon_rssi);
#if ATH_SUPPORT_DFS && ATH_SUPPORT_STA_DFS
qdf_export_symbol(mlme_set_stacac_valid);
#endif
qdf_export_symbol(ieee80211_indicate_sta_radar_detect);
qdf_export_symbol(channel_switch_set_channel);
...
qdf_export_symbol(ieee80211_wme_amp_overloadparams_locked);
...
#if DA_SUPPORT
qdf_export_symbol(ieee80211_resmgr_attach);
#endif

#if ATH_SUPPORT_DFS && ATH_SUPPORT_STA_DFS
qdf_export_symbol(mlme_reset_mlme_req);
qdf_export_symbol(wlan_mlme_sm_get_curstate);
...
#if ATH_SUPPORT_HYFI_ENHANCEMENTS
qdf_export_symbol(ald_init_netlink);
qdf_export_symbol(ald_destroy_netlink);
qdf_export_symbol(ieee80211_ald_update_phy_error_rate);
#endif
...
qdf_export_symbol(ath_initialize_timer_module);
qdf_export_symbol(ath_initialize_timer_int);
qdf_export_symbol(ath_set_timer_period);
qdf_export_symbol(ath_timer_is_initialized);
qdf_export_symbol(ath_start_timer);
qdf_export_symbol(ath_cancel_timer);
qdf_export_symbol(ath_timer_is_active);
qdf_export_symbol(ath_free_timer_int);

/* Export ath_wbuf.c functions */
qdf_export_symbol(__wbuf_uapsd_update);

/* Export if_bus.c functions*/
qdf_export_symbol(bus_read_cachesize);
...
#if ATH_SUPPORT_HYFI_ENHANCEMENTS
qdf_export_symbol(ieee80211_ioctl_ald_getStatistics);
#endif
qdf_export_symbol(ieee80211_bcn_prb_template_update);
...
#endif
qdf_export_symbol(ieee80211_vap_deliver_stop_error);
...
#ifndef WLAN_CONV_CRYPTO_SUPPORTED
qdf_export_symbol(ieee80211_node_clear_keys);
#endif
...
qdf_export_symbol(ieee80211_vap_deliver_stop);
...
qdf_export_symbol(acs_debug_add_chan_event);

/*
 * Copyright (c) 2011, 2017-19 Qualcomm Innovation Center, Inc.
 *
 * All Rights Reserved.
        ...
        apstats_recursion_t recursion)
{
    ...
    APSTATS_PRINT_STAT16_SIGNED("lithium_cycle_cnt: Chan NF (BDF averaged NF_dBm)",
            radiostats->chan_nf);
        ...
        apstats_recursion_t recursion)
{
    ...
    APSTATS_PRINT_STAT64("Tx Broadcast Data Bytes",
    ...
    APSTATS_PRINT_STAT64("Peer delete all req", vapstats->peer_delete_all_req);
    APSTATS_PRINT_STAT64("Peer delete all resp", vapstats->peer_delete_all_resp);
...
#ifdef VDEV_PEER_PROTOCOL_COUNT
static void nodelevel_display_stats_peer_prot(nodelevel_stats_t *nodestats)
{
    APSTATS_PRINT_GENERAL("Data Packets PROTOCOL Based:\n");
    APSTATS_PRINT_STAT16(" ICMP tx ingress", nodestats->icmp_tx_ingress);
    APSTATS_PRINT_STAT16(" ICMP tx egress",  nodestats->icmp_tx_egress);
    APSTATS_PRINT_STAT16(" ICMP rx ingress", nodestats->icmp_rx_ingress);
    APSTATS_PRINT_STAT16(" ICMP rx egress",  nodestats->icmp_rx_egress);

    APSTATS_PRINT_STAT16(" ARP tx ingress", nodestats->arp_tx_ingress);
    APSTATS_PRINT_STAT16(" ARP tx egress",  nodestats->arp_tx_egress);
    APSTATS_PRINT_STAT16(" ARP rx ingress", nodestats->arp_rx_ingress);
    APSTATS_PRINT_STAT16(" ARP rx egress",  nodestats->arp_rx_egress);

    APSTATS_PRINT_STAT16(" EAP tx ingress", nodestats->eap_tx_ingress);
    APSTATS_PRINT_STAT16(" EAP tx egress",  nodestats->eap_tx_egress);
    APSTATS_PRINT_STAT16(" EAP rx ingress", nodestats->eap_rx_ingress);
    APSTATS_PRINT_STAT16(" EAP rx egress",  nodestats->eap_rx_egress);
}
#else
static void nodelevel_display_stats_peer_prot(nodelevel_stats_t *nodestats)
{
...
static int nodelevel_display_stats(nodelevel_stats_t *nodestats)
{
...
#endif
    nodelevel_display_stats_peer_prot(nodestats);
    ...
    APSTATS_PRINT_STAT64("Tx Success Broadcast Data Packets", nodestats->tx_bcast_data_packets);
    APSTATS_PRINT_STAT64("Tx Success Broadcast Data Bytes",   nodestats->tx_bcast_data_bytes);
#endif
    ...
    APSTATS_PRINT_STAT64("Tx failed",             nodestats->tx_failed);

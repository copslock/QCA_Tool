...
end0 :   
    if (sendbar && !ath_vap_pause_in_progress(sc)) {
        ...
        qdf_nofl_info("%s:txq pause is in progress\n",__func__);
    }
...
#if ATH_DEBUG
qdf_export_symbol(dprintf);
#endif  /* ATH_DEBUG */

qdf_export_symbol(ath_tx_pause_tid);
qdf_export_symbol(ath_tx_resume_tid);
qdf_export_symbol(ath_tx_send_normal);
qdf_export_symbol(ath_tx_send_ampdu);
qdf_export_symbol(ath_txq_schedule);
qdf_export_symbol(ath_tx_num_badfrms);
qdf_export_symbol(ath_tx_complete_aggr_rifs);


qdf_export_symbol(_ath_tx_complete_buf);

#if ATH_TX_COMPACT
qdf_export_symbol( ath_tx_complete_aggr_compact);
qdf_export_symbol(ath_tx_complete_buf);
qdf_export_symbol( ath_edma_free_complete_buf);
#endif

qdf_export_symbol(ath_tx_update_stats);
qdf_export_symbol(ath_txq_depth);
qdf_export_symbol(ath_buf_set_rate);
qdf_export_symbol(ath_txto_tasklet);
qdf_export_symbol(ath_tx_get_rts_retrylimit);
qdf_export_symbol(ath_tx_update_minimal_stats);

qdf_export_symbol(ath_tx_uapsd_complete);
qdf_export_symbol(ath_tx_queue_uapsd);

qdf_export_symbol(ath_pwrsave_set_state);
#if ATH_SUPPORT_FLOWMAC_MODULE
//ATH_SUPPORT_VOWEXT
qdf_export_symbol(ath_netif_stop_queue);
#endif
qdf_export_symbol(ath_edmaAllocRxbufsForFreeList);
qdf_export_symbol(ath_rx_edma_intr);
qdf_export_symbol(ath_hw_hang_check);
qdf_export_symbol(ath_beacon_tasklet);
qdf_export_symbol(ath_bstuck_tasklet);
qdf_export_symbol(ath_beacon_config);
qdf_export_symbol(ath_bmiss_tasklet);

qdf_export_symbol(ath_allocRxbufsForFreeList);
#if ATH_SUPPORT_DESCFAST
qdf_export_symbol(ath_rx_proc_descfast);
#endif

#ifdef ATH_GEN_TIMER
qdf_export_symbol(ath_gen_timer_isr);
qdf_export_symbol(ath_gen_timer_tsfoor_isr);
#if ATH_RX_LOOPLIMIT_TIMER
qdf_export_symbol(ath_gen_timer_start);
qdf_export_symbol(ath_gen_timer_stop);
qdf_export_symbol(ath_gen_timer_gettsf32);

extern int ath_rx_looplimit_handler(void *arg);
qdf_export_symbol(ath_rx_looplimit_handler);
#endif
#endif

qdf_export_symbol(ath_handle_rx_intr);
#if ATH_SUPPORT_PAPRD
qdf_export_symbol(ath_tx_paprd_complete);
#endif
qdf_export_symbol(ath_tx_tasklet);

qdf_export_symbol(ath_rx_process_uapsd);
#ifdef ATH_SUPPORT_TxBF
qdf_export_symbol(ath_rx_bf_handler);
qdf_export_symbol(ath_rx_bf_process);
qdf_export_symbol(ath_txbf_chk_rpt_frm);
#endif
#if ATH_SUPPORT_LED
qdf_export_symbol(ath_led_report_data_flow);
#endif
qdf_export_symbol(ath_rx_requeue);
qdf_export_symbol(ath_bar_rx);
qdf_export_symbol(ath_ampdu_input);
qdf_export_symbol(ath_setdefantenna);
#ifdef ATH_SWRETRY
qdf_export_symbol(ath_form_swretry_frm);
qdf_export_symbol(ath_check_swretry_req);
#if ATH_SWRETRY_MODIFY_DSTMASK
qdf_export_symbol(ath_tx_modify_cleardestmask);
#endif
qdf_export_symbol(ath_tx_mpdu_requeue);
qdf_export_symbol(ath_tx_mpdu_resend);
qdf_export_symbol(ath_tx_dec_eligible_frms);
#endif
#if LMAC_SUPPORT_POWERSAVE_QUEUE
qdf_export_symbol(ath_node_pwrsaveq_queue);
#endif //LMAC_SUPPORT_POWERSAVE_QUEUE

#if ATH_SUPPORT_VOW_DCS
qdf_export_symbol(ath_rx_duration);
#endif

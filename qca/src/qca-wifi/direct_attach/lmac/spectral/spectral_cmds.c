...
{
    qdf_nofl_info("ss_fft_period      : %d\n", p->ss_fft_period);
    qdf_nofl_info("ss_period          : %d\n", p->ss_period);
    qdf_nofl_info("ss_count           : %d\n", p->ss_count);
    qdf_nofl_info("ss_short_report    : %d\n", p->ss_short_report);
    qdf_nofl_info("ss_fft_size        : %d\n", p->ss_fft_size);
    qdf_nofl_info("ss_gc_ena          : %d\n", p->ss_gc_ena);
    qdf_nofl_info("ss_restart_ena     : %d\n", p->ss_restart_ena);
    qdf_nofl_info("ss_noise_floor_ref : %d\n", p->ss_noise_floor_ref);
    qdf_nofl_info("ss_init_delay      : %d\n", p->ss_init_delay);
    qdf_nofl_info("ss_nb_tone_thr     : %d\n", p->ss_nb_tone_thr);
    qdf_nofl_info("ss_str_bin_thr     : %d\n", p->ss_str_bin_thr);
    qdf_nofl_info("ss_wb_rpt_mode     : %d\n", p->ss_wb_rpt_mode);
    qdf_nofl_info("ss_rssi_rpt_mode   : %d\n", p->ss_rssi_rpt_mode);
    qdf_nofl_info("ss_rssi_thr        : %d\n", p->ss_rssi_thr);
    qdf_nofl_info("ss_pwr_format      : %d\n", p->ss_pwr_format);
    qdf_nofl_info("ss_rpt_mode        : %d\n", p->ss_rpt_mode);
    qdf_nofl_info("ss_bin_scale       : %d\n", p->ss_bin_scale);
    qdf_nofl_info("ss_dbm_adj         : %d\n", p->ss_dbm_adj);
    qdf_nofl_info("ss_chn_mask        : %d\n", p->ss_chn_mask);
    qdf_nofl_info("radar threshold    : %d\n", p->radar_bin_thresh_sel);
}
...
void stop_current_scan_da(struct wlan_objmgr_pdev *pdev)
{
    ...
    if (spectral == NULL) {
        qdf_nofl_info("SPECTRAL : Spectral is NUll  (%s)\n", __func__);
        return;
    }
...
qdf_export_symbol(stop_current_scan_da);
...
qdf_export_symbol(start_spectral_scan_da);

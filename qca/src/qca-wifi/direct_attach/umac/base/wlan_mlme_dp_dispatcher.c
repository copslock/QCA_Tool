...
qdf_export_symbol(wlan_vdev_get_powersave);
...
qdf_export_symbol(wlan_pdev_get_curchan_freq);
...
qdf_export_symbol(wlan_pdev_get_curchan);
...
qdf_export_symbol(wlan_pdev_find_channel);
...
qdf_export_symbol(wlan_pdev_get_qwrap_isolation);
#endif
...
qdf_export_symbol(wlan_vdev_is_radar_channel);
...
qdf_export_symbol(wlan_vdev_sta_power_tx_start);
...
qdf_export_symbol(wlan_vdev_sta_power_tx_end);
...
qdf_export_symbol(wlan_peer_saveq_queue);
...
qdf_export_symbol(wlan_find_wds_peer);
...
qdf_export_symbol(wlan_set_wds_node_time);
...
qdf_export_symbol(wlan_add_wds_addr);
...
qdf_export_symbol(wlan_remove_wds_addr);
...
qdf_export_symbol(wlan_find_wds_peer_age);
...
qdf_export_symbol(wlan_admctl_classify);
...
qdf_export_symbol(wlan_nawds_send_wbuf);
...
qdf_export_symbol(wlan_vdev_nawds_enable_learning);
...
qdf_export_symbol(wlan_vdev_set_tim);
...
qdf_export_symbol(wlan_crypto_get_txkey);
...
#endif
qdf_export_symbol(wlan_crypto_peer_get_key);
...
qdf_export_symbol(wlan_crypto_peer_encap);
...
qdf_export_symbol(wlan_crypto_peer_decap);
...
qdf_export_symbol(wlan_vdev_get_def_txkey);
#endif
...
qdf_export_symbol(wlan_vdev_get_nw_keys);
...
qdf_export_symbol(wlan_crypto_enmic);
#endif
...
#endif
qdf_export_symbol(wlan_vdev_crypto_demic);
...
qdf_export_symbol(wlan_prepare_qosnulldata);
...
qdf_export_symbol(wlan_vdev_get_mgt_rate);
...
qdf_export_symbol(wlan_peer_get_bf_update_cv);
...
qdf_export_symbol(wlan_request_cv_update);
...
qdf_export_symbol(wlan_vdev_forced_sleep_is_set);
...
qdf_export_symbol(wlan_ald_record_tx);
#endif
...
qdf_export_symbol(wlan_vdev_get_rsn);
#endif
...
qdf_export_symbol(wlan_pdev_get_tx_staggered_sounding);
...
qdf_export_symbol(wlan_pdev_get_ldpcap);
...
qdf_export_symbol(wlan_pdev_get_curmode);
...
qdf_export_symbol(wlan_vdev_get_bsschan);
...
qdf_export_symbol(wlan_is_vdev_mpsta);
...
qdf_export_symbol(wlan_is_vdev_psta);
#endif
...
qdf_export_symbol(wlan_vdev_get_sta_assoc);
...
qdf_export_symbol(wlan_pdev_get_wmep_acm);
...
qdf_export_symbol(wlan_pdev_get_wmep_noackPolicy);
...
qdf_export_symbol(wlan_peer_get_pspoll);
...
qdf_export_symbol(wlan_peer_get_rx_staggered_sounding);
...
qdf_export_symbol(wlan_peer_get_htcap);
...
qdf_export_symbol(wlan_peer_get_channel_estimation_cap);
...
qdf_export_symbol(wlan_peer_get_txseqs);
...
qdf_export_symbol(wlan_peer_set_txseqs);
...
qdf_export_symbol(wlan_peer_incr_txseq);
...
qdf_export_symbol(wlan_vdev_wnm_is_set);
...
qdf_export_symbol(wlan_vdev_wnm_fms_is_set);
...
qdf_export_symbol(wlan_fms_filter);
...
qdf_export_symbol(wlan_dbdc_tx_process);
...
qdf_export_symbol(wlan_osif_wrap_wdev_find);
#endif
...
qdf_export_symbol(wlan_vdev_wnm_tfs_filter);
...
qdf_export_symbol(wlan_do_proxy_arp);
#endif
...
qdf_export_symbol(wlan_peer_pause);
...
qdf_export_symbol(wlan_peer_unpause);
...
qdf_export_symbol(wlan_vdev_set_lastdata_timestamp);
...
qdf_export_symbol(wlan_vdev_set_last_directed_frame);
...
qdf_export_symbol(wlan_vdev_get_lastbcn_phymode_mismatch);
...
qdf_export_symbol(wlan_vdev_get_bmiss_count);
...
qdf_export_symbol(wlan_set_dadp_ops);
...
qdf_export_symbol(wlan_pdev_get_dadp_ops);
...
qdf_export_symbol(wlan_pdev_get_extap_handle);
...
qdf_export_symbol(wlan_peer_update_uapsd_dyn_delivena);
...
qdf_export_symbol(wlan_peer_update_uapsd_dyn_trigena);
...
qdf_export_symbol(wlan_vdev_get_curmode);
...
qdf_export_symbol(wlan_vdev_has_pssta);
...
qdf_export_symbol(wlan_vdev_get_rtsthreshold);
...
qdf_export_symbol(wlan_peer_get_bssid);
...
qdf_export_symbol(wlan_peer_reload_inact);
...
qdf_export_symbol(wlan_peer_set_inact);
...
qdf_export_symbol(wlan_pdev_set_athextcap);
...
qdf_export_symbol(wlan_pdev_clear_athextcap);
...
qdf_export_symbol(wlan_kick_peer);
...
qdf_export_symbol(wlan_wnm_bssmax_updaterx);
...
qdf_export_symbol(wlan_peer_get_associd);
...
qdf_export_symbol(wlan_peer_get_txpower);
...
qdf_export_symbol(wlan_peer_check_cap);
...
qdf_export_symbol(wlan_send_deauth);
...
qdf_export_symbol(wlan_send_disassoc);
...
qdf_export_symbol(wlan_vdev_deliver_event_mlme_deauth_indication);
...
qdf_export_symbol(wlan_vdev_deliver_event_mlme_disassoc_indication);
...
qdf_export_symbol(wlan_tx_bf_completion_handler);
#endif
...
qdf_export_symbol(wlan_peer_get_nodetable);
...
qdf_export_symbol(wlan_vdev_reset_bmiss);
...
qdf_export_symbol(wlan_peer_set_rssi);
...
qdf_export_symbol(wlan_peer_set_rssi_min_max);
...
qdf_export_symbol(wlan_peer_mlme_pwrsave);
...
qdf_export_symbol(wlan_vdev_get_wow);
...
qdf_export_symbol(wlan_peer_wow_magic_parser);
#endif
...
qdf_export_symbol(wlan_wds_update_rootwds_table);
...
qdf_export_symbol(wlan_vdev_wds_sta_chkmcecho);
...
qdf_export_symbol(wlan_peer_leave);
...
qdf_export_symbol(wlan_peer_set_beacon_rstamp);
...
qdf_export_symbol(wlan_peer_set_probe_ticks);
...
qdf_export_symbol(wlan_create_tmp_peer);
...
qdf_export_symbol(wlan_peer_delete);
...
qdf_export_symbol(wlan_vdev_vi_dbg_input);
#endif
...
qdf_export_symbol(wlan_vdev_nawds_learn);
...
qdf_export_symbol(wlan_peer_recv_ctrl);
...
qdf_export_symbol(wlan_vdev_rx_gate);
...
qdf_export_symbol(wlan_vdev_rx_ungate);
...
qdf_export_symbol(wlan_vdev_deauth_request);
...
qdf_export_symbol(wlan_cmn_input_mgmt);

int wlan_me_Convert(struct wlan_objmgr_vdev *vdev, wbuf_t wbuf,
		    u_int8_t newmac[][QDF_MAC_ADDR_SIZE], uint8_t newmaccnt)
{
	struct wlan_objmgr_pdev *pdev = wlan_vdev_get_pdev(vdev);
	struct dadp_ops *dops = wlan_pdev_get_dadp_ops(pdev);

...
qdf_export_symbol(son_da_sanitize_util_intvl);
...
qdf_export_symbol(son_da_enable);
...
qdf_export_symbol(son_da_send_null);
...
qdf_export_symbol(son_da_get_peer_rate);
...
qdf_export_symbol(son_da_lmac_create);
...
qdf_export_symbol(son_da_rx_rssi_update);
...
qdf_export_symbol(son_da_rx_rate_update);
...
qdf_export_symbol(son_da_lmac_destroy);
#else

...
struct ath_hal_9300 {
    ...
    u_int8_t    ah_macaddr[QDF_MAC_ADDR_SIZE];
    u_int8_t    ah_bssid[QDF_MAC_ADDR_SIZE];
    u_int8_t    ah_bssid_mask[QDF_MAC_ADDR_SIZE];
...
extern  bool ar9300_reset_key_cache_entry(struct ath_hal *ah, u_int16_t entry, u_int8_t clear_key);

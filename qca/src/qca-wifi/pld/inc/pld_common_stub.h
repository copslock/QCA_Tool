...
static void pld_wait_for_fw_ready(struct device *dev)
{
}

static void pld_wait_for_cold_boot_cal_done(struct device *dev)
{
}
...
static void pld_set_ramdump_enabled(struct device *dev, bool enabled)
{
}

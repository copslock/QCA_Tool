...
struct ieee80211_node *wlan_objmgr_find_node_debug(struct ieee80211_node_table *nt,
                                              ...
                                              const char *func, int line)
{
   ...
   peer = wlan_objmgr_get_peer_debug(nt->psoc, pdev_id, macaddr, id, func, line);
   if(peer == NULL) {
      return NULL;
   }
                                    ...
                                    const char *func, int line)
{
   ...
   peer = wlan_objmgr_get_peer_by_mac_n_vdev_debug(nt->psoc, pdev_id, bssid, macaddr,
                                                   id, func, line);
   if(peer == NULL) {
      return NULL;
   }
...
qdf_list_t *wlan_objmgr_populate_logically_deleted_node_list_debug(struct ieee80211_node_table *nt,
                                              ...
                                              const char *func, int line)
{
    ...
    return wlan_objmgr_populate_logically_deleted_peerlist_by_mac_n_vdev_debug(nt->psoc, pdev_id, bssid, macaddr,
                                                                               id, func, line);
}
#else

...
qdf_export_symbol(wlan_ic_psoc_set_flag);
...
qdf_export_symbol(wlan_ic_psoc_clear_flag);
...
qdf_export_symbol(wlan_ic_psoc_set_extflag);
...
qdf_export_symbol(wlan_ic_pdev_set_flag);
...
qdf_export_symbol(wlan_ic_pdev_clear_flag);
...
qdf_export_symbol(wlan_ic_pdev_set_extflag);
...
qdf_export_symbol(wlan_vap_vdev_set_flag);
...
qdf_export_symbol(wlan_vap_vdev_clear_flag);
...
qdf_export_symbol(wlan_vap_vdev_set_extflag);
...
qdf_export_symbol(wlan_vap_vdev_set_ext2flag);
...
qdf_export_symbol(wlan_vap_vdev_clear_ext2flag);
...
qdf_export_symbol(wlan_ic_psoc_set_cap);
...
qdf_export_symbol(wlan_ic_psoc_clear_cap);
...
qdf_export_symbol(wlan_ic_psoc_set_extcap);
...
qdf_export_symbol(wlan_ic_psoc_clear_extcap);
...
qdf_export_symbol(wlan_ic_pdev_set_cap);
...
qdf_export_symbol(wlan_ic_pdev_clear_cap);
...
qdf_export_symbol(wlan_ic_pdev_set_extcap);
...
qdf_export_symbol(wlan_ic_pdev_clear_extcap);
...
qdf_export_symbol(wlan_node_peer_set_flag);
...
qdf_export_symbol(wlan_node_peer_clear_flag);

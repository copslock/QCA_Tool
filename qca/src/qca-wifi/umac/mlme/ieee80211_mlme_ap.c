    ...
    */
    ...
    if (ni->ni_assocstatus != IEEE80211_STATUS_SUCCESS) {
        ...
        if (ieee80211_node_is_authorized(ni)) {
            ...
            ald_assoc_notify(vap, ni->ni_macaddr, ALD_ACTION_ASSOC, ni->ni_assocstatus);
#endif
    ...
    if (coex_enabled) {
        if (IEEE80211_IS_CHAN_11NG_HT40PLUS(chan) ||
            ...
            if (chan->ic_flags & IEEE80211_CHAN_HT40INTOL) {
                ...
                ht20chan = ieee80211_find_dot11_channel(ic, chan->ic_freq, 0,
            ...
            if (chan->ic_flags & IEEE80211_CHAN_HE40INTOL) {
                ...
                he20chan = ieee80211_find_dot11_channel(ic, chan->ic_freq, 0,

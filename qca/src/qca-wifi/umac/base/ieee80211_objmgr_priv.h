...
struct ieee80211_node *wlan_objmgr_find_node_debug(struct ieee80211_node_table *nt, uint8_t *macaddr,
                              wlan_objmgr_ref_dbgid id, const char *func, int line);

qdf_list_t *wlan_objmgr_populate_logically_deleted_node_list_debug
...
static inline void
wlan_vdev_set_mlme_ext_obj(struct wlan_objmgr_vdev *vdev,

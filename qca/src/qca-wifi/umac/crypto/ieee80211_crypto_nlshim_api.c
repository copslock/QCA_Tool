                                  ...
                                  enum nl80211_auth_type  auth_type)
{
    ...
    u_int8_t set_wapi =0xf; /* used to setup the wapi vap */
#endif
...
#define IEEE80211_KEY_GROUP 0x04
  ...
  /* Need to remove wk ? . No more useful ?*/
   ...
   if(key_val.keytype == IEEE80211_CIPHER_WEP
    ...
    qdf_mem_zero(&key_val, sizeof(ieee80211_keyval));
    qdf_mem_zero(&wk, sizeof(struct ieee80211req_key));
    key_index = 0;
    return 0;
}

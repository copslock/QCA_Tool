...
typedef enum {
	...
	/* Get radio CAC capabilities */
	SON_DISPATCHER_CMD_MAP_GET_CAC_CAP = 24,
	/* Get opclass info for MAP */
	SON_DISPATCHER_CMD_MAP_GET_OP_CLASS_INFO = 25,
} SON_DISPATCHER_CMD;
...
typedef enum {
	...
	SON_MAP_CAPABILITY_ASSOC_STATUS = 4,
	SON_MAP_CAPABILITY_BSTA_VLAN_ID = 5,
} son_map_capability;

/**
 * @brief Enum for version numbers for EasyMesh
 */
typedef enum {
	EASYMESH_DISABLED,
	EASYMESH_VERSION_ONE,
	EASYMESH_VERSION_TWO,
} easymesh_version;

/* Bit mask for Multi-AP IE */
#define MAP_BSS_TEARDOWN     0x10
...
#define MAP2_PROFILE_SUBELEMENT_BIT 9
#define MAP2_PROFILE_SUBELEMENT 0x07
#define MAP2_8021Q_SETTING_SUBELEMENT 0x08
...
#define SON_CAPABILITY_IS_VALID 1

...
struct ieee80211_acs {
    ...
    uint16_t                            acs_ch_idx[IEEE80211_ACS_CHAN_MAX];       /* channel mapping array */
...
#define ACS_RSSI_NEAR_RANGE_MIN 60
#define ACS_RSSI_MID_RANGE_MIN 30
#define ACS_RSSI_FAR_RANGE_MIN 0

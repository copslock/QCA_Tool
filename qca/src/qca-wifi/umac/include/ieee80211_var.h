...
#define IC_IEEE80211_FIND_NODE(_ic,_nt,_macaddr,_id)  (_ic)->ic_ieee80211_find_node_debug((_nt),(_macaddr),(_id), __FUNCTION__, __LINE__, __FILE__)
    struct  ieee80211_node*  (*ic_ieee80211_find_node_debug)(struct ieee80211_node_table *nt, const u_int8_t *macaddr, wlan_objmgr_ref_dbgid id, const char * func, int line, const char *file);
#else
#define IC_IEEE80211_FIND_NODE(_ic,_nt,_macaddr,_id)  (_ic)->ic_ieee80211_find_node((_nt),(_macaddr),(_id))
    struct  ieee80211_node*  (*ic_ieee80211_find_node)(struct ieee80211_node_table *nt, const u_int8_t *macaddr, wlan_objmgr_ref_dbgid id);
    ...
    uint8_t                       ic_oob_enable; /* OOB advertisement enabled for this radio */
    /*
    ...
    void (*ic_prb_rsp_free)(struct ieee80211com *ic, int if_id, struct ieee80211vap *vap);
    ...
    int                     (*ic_frame_injector_config)(struct ieee80211vap *vap,
                                                        u_int32_t frametype,
                                                        u_int32_t enable,
...
#define QOS_ACTION_FRAME_MASK (QOS_ACTION_FRAME_HNDL_UP_STACK | QOS_ACTION_FRAME_FRWD_TO_STACK)
    ...
    void                                (*ic_vap_pause_inc)(struct ieee80211vap *);
    void                                (*ic_vap_pause_set_param)(struct ieee80211vap *, ieee80211_param param, u_int32_t val);
    u_int32_t                           (*ic_vap_pause_get_param)(struct ieee80211vap *, ieee80211_param param);
#endif
...
/* not multiple thread safe */
    ...
    u_int32_t                         iv_256qam:1,     /* 256 QAM support in 2.4GHz mode Enable:1 Disable:0 */
                                      ...
                                      iv_ext_ifu_acs:1,  /* Enable external auto channel selection
...
*/
 ...
 u_int8_t                   iv_pause_scan;
    ...
    u_int8_t                   iv_rawmodesim_txaggr:4,    /* per VAP Enable/disable raw mode simulation Tx A-MSDU aggregation */
                               iv_rawmodesim_debug:1;     /* per VAP Enable/disable raw mode simulation debug */
#endif /* QCA_SUPPORT_RAWMODE_PKT_SIMULATION */
...
static INLINE uint32_t ieee80211com_he_target_supports_mac_cap
                            (struct ieee80211com *ic,
                             int *he_target_cap,
                             uint32_t maccap) {
    ...
    switch (maccap) {
        case IEEE80211_CONFIG_HE_FRAGMENTATION:
            *he_target_cap = HECAP_MAC_HEFRAG_GET_FROM_IC(ic_hecap_mac);
        break;
        case IEEE80211_CONFIG_HE_HT_CTRL:
            *he_target_cap = HECAP_MAC_HECTRL_GET_FROM_IC(ic_hecap_mac);
        break;
#if SUPPORT_11AX_D3
        case IEEE80211_CONFIG_HE_MULTI_TID_AGGR:
            *he_target_cap = HECAP_MAC_MTIDRXSUP_GET_FROM_IC(ic_hecap_mac);
        break;
        case IEEE80211_CONFIG_HE_MULTI_TID_AGGR_TX:
            *he_target_cap = HECAP_MAC_MTIDTXSUP_GET_FROM_IC(ic_hecap_mac);
        break;
        ...
        case IEEE80211_CONFIG_HE_MIN_FRAG_SIZE:
            *he_target_cap = HECAP_MAC_MINFRAGSZ_GET_FROM_IC(ic_hecap_mac);
        break;
        case IEEE80211_CONFIG_HE_OMI:
            *he_target_cap = HECAP_MAC_OMI_GET_FROM_IC(ic_hecap_mac);
        break;
        default:
...
static INLINE uint32_t ieee80211com_he_target_supports_phy_cap
                            (struct ieee80211com *ic,
                             int *he_target_cap,
                             uint32_t phycap) {

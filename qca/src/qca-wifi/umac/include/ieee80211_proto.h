...
struct ieee80211_framing_extractx {
    ...
    bool    is_6ghz_bcast_prbreq;      /* Probe req with Bcast Addr1 */
    u_int8_t ssid_len;
...
int ieee80211_send_unprotected_deauth(struct ieee80211vap *vap, u_int8_t *dstmac, u_int16_t reason);
...
struct ieee80211_beacon_offsets {
    ...
    u_int8_t    *bo_ibssdfs; /* 14. IBSS DFS */
    u_int16_t   bo_ibssdfs_trailerlen;
#endif /* ATH_SUPPORT_IBSS_DFS */

    u_int8_t    *bo_tpcreport; /* 15. TPC Report */
    u_int8_t    *bo_erp; /* 16. ERP */
    u_int8_t    *bo_xrates; /* 17.Extended Supported Rates */
    u_int8_t    *bo_rsn; /* 18. RSN */
    u_int8_t    *bo_qbssload; /* 19. QBSS Load */
    u_int8_t    *bo_edca; /* 20. EDCA Parameter Set */
    u_int8_t    *bo_qos_cap; /* 21. QoS Capability */
    u_int8_t    *bo_ap_chan_rpt; /* 22. AP Channel Report */
    u_int8_t    *bo_bss_avg_delay; /* 23. BSS Average Access Delay */
    u_int8_t    *bo_antenna; /* 24. Antenna */
    u_int8_t    *bo_bss_adm_cap; /* 25. BSS Available Admission Capacity */
#ifndef ATH_SUPPORT_WAPI
    u_int8_t    *bo_bss_ac_acc_delay; /* 26. BSS AC Access Delay */
#endif
    u_int8_t    *bo_msmt_pilot_tx; /* 27. Measurement Pilot Transmissions */

    u_int8_t    *bo_mbssid_ie; /* 28. Multiple BSSID */

    u_int8_t    *bo_mob_domain; /* 30. Mobility domain */
    u_int8_t    *bo_dse_reg_loc; /* 31. DSE Registered Location */

    u_int8_t    *bo_ecsa; /* 32. Extended Channel Switch Announcement */

    u_int8_t    *bo_opt_class; /* 33. Supported Operating Classes */
    u_int8_t    *bo_htcap; /* 34. HT Capabilities */
    u_int8_t    *bo_htinfo; /* 35. HT Info/Opertaion */
    u_int8_t    *bo_2040_coex; /* 36. 20/40 BSS Coexistence */
    u_int8_t    *bo_obss_scan; /* 37. Overlapping BSS Scan Parameters */
    u_int8_t    *bo_extcap; /* 38. Extended Capabilities */

#if UMAC_SUPPORT_WNM
    u_int16_t   bo_fms_len; /* FMS desc length in bytes */
    u_int16_t   bo_fms_trailerlen; /* FMS desc trailer length in bytes */
    u_int8_t    *bo_fms_desc; /* 39. FMS Descriptor */
    u_int8_t    *bo_fms_trailer; /* FMS desc trailer */
#endif

    u_int8_t    *bo_qos_traffic; /* 40. QoS Traffic Capability */
    u_int8_t    *bo_time_adv; /* 41. Time Advertisement */
    u_int8_t    *bo_interworking; /* 42. Interworking */
    u_int8_t    *bo_adv_proto; /* 43. Advertisement protocol */
    u_int8_t    *bo_roam_consortium; /* 44. Roaming consortium */
    u_int8_t    *bo_emergency_id; /* 45. Emergency Alert Identifier */
    u_int8_t    *bo_mesh_id; /* 46. Mesh ID */
    u_int8_t    *bo_mesh_conf; /* 47. Mesh Configuration */
    u_int8_t    *bo_mesh_awake_win; /* 48. Mesh Awake window */
    u_int8_t    *bo_beacon_time; /* 49. Beacon Timing */
    u_int8_t    *bo_mccaop_adv_ov; /* 50. MCCAOP Advertisement Overview */
    u_int8_t    *bo_mccaop_adv; /* 51. MCCAOP Advertisement */
    u_int8_t    *bo_mesh_cs_param; /* 52. Mesh Channel Switch Parameters */
    u_int8_t    *bo_qmf_policy; /* 53. QMF Policy */
    u_int8_t    *bo_qload_rpt; /* 54. QLoad Report */
    u_int8_t    *bo_hcca_upd_cnt; /* 55. HCCA TXOP Update Count */
    u_int8_t    *bo_multiband; /* 56. Multi-band */
    u_int8_t    *bo_vhtcap; /* 57. VHT capability element */
    u_int8_t    *bo_vhtop; /* 58. VHT operational element */
    u_int8_t    *bo_vhttxpwr; /* 59. VHT Tx power Envelope element */

    u_int8_t    *bo_vhtchnsw; /* 60. VHT Channel switch wrapper element */

    u_int8_t    *bo_ext_bssload; /* 61. Extended BSS Load element */
    u_int8_t    *bo_quiet_chan; /* 62. Quiet Channel */
    u_int8_t    *bo_opt_mode_note; /* 63. Operating Mode Notification */
    u_int8_t    *bo_rnr; /* 64. Reduced Neighbor Report */
    u_int8_t    *bo_tvht; /* 65. TVHT Operation */

#if QCN_ESP_IE
    u_int8_t    *bo_esp_ie; /* 66. Estimated Service Parameters */
    u_int16_t   bo_esp_ie_len; /* Lenght of ESP */
#endif

    u_int8_t    *bo_future_chan; /* 67. Future Channel Guidance */
    u_int8_t    *bo_cag_num; /* 68. Common Advertisement Group (CAG) Number */
    u_int8_t    *bo_fils_ind; /* 69. FILS Indication */
    u_int8_t    *bo_ap_csn; /* 70. AP-CSN */
    u_int8_t    *bo_diff_init_lnk; /* 71. Differentiated Initial Link Setup */
    u_int8_t    *bo_service_hint; /* 72. Service Hint */
    u_int8_t    *bo_service_hash; /* 73. Service Hash */
    u_int8_t    *bo_hecap; /* 76. HE Capabilities */
    u_int8_t    *bo_heop; /* 77. HE Operation */
    u_int8_t    *bo_twt; /* 78. TWT */

#if ATH_SUPPORT_UORA
    u_int8_t    *bo_uora_param; /* 79. UORA Parameter Set */
#endif

    u_int8_t    *bo_bcca; /* 80. BSS Color Change Announcement*/

#if OBSS_PD
    u_int8_t    *bo_srp_ie; /* 81. Spatial Reuse Parameter (SRP) set */
    u_int16_t   bo_srp_ie_len; /* SRP_IE length */
#endif

    u_int8_t    *bo_muedca; /* 82. MU EDCA parameter set */
    u_int8_t    *bo_ess_rpt; /* 83. ESS Report */
    u_int8_t    *bo_ndp_rpt_param; /* 84. NDP Feedback Report Parameter */
    u_int8_t    *bo_he_bss_load; /* 85. HE BSS Load */
...
u_int8_t *ieee80211_add_tpc_ie(u_int8_t *, struct ieee80211vap *vap);
void ieee80211_adjust_bos_for_bsscolor_change_ie(
        struct ieee80211_beacon_offsets *bo, uint8_t offset);
uint8_t *ieee80211_mbss_add_profile(u_int8_t *frm, struct ieee80211_node *ni,

...
void wlan_objmgr_free_node_debug(struct ieee80211_node *ni, wlan_objmgr_ref_dbgid id, const char *func, int line);
void wlan_objmgr_ref_node_debug(struct ieee80211_node *node, wlan_objmgr_ref_dbgid id, const char *func, int line);
QDF_STATUS wlan_objmgr_try_ref_node_debug(struct ieee80211_node *node,
                                    wlan_objmgr_ref_dbgid id, const char *func, int line);
void wlan_objmgr_unref_node_debug(struct ieee80211_node *ni, wlan_objmgr_ref_dbgid id, const char *func, int line);
#else
...
#if WLAN_OBJMGR_REF_ID_TRACE
#define wlan_objmgr_free_node(node, dbgid) \
           wlan_objmgr_free_node_debug(node, dbgid, __func__, __LINE__)
#define wlan_objmgr_try_ref_node(node, dbgid) \
           wlan_objmgr_try_ref_node_debug(node, dbgid, __func__, __LINE__)
#endif

...
#define    WLAN_PEER_CP_STAT_ADDRBASED(_vap, _macaddr, stat) \
                    {\
                        ...
                        if ((_ni = ieee80211_find_node(&(_vap)->iv_ic->ic_sta, (_macaddr), WLAN_MLME_SB_ID)) != NULL) {\
...
#define ieee80211_find_node(nt, mac, id)    \
    ieee80211_find_node_debug(nt, mac, id, __func__, __LINE__, __FILE__)
...
#else
#define ieee80211_vap_find_node(_vap, _mac, id)     \
    ieee80211_find_node_debug(&(_vap)->iv_ic->ic_sta, _mac, id, __func__, __LINE__, __FILE__)
#endif
...
#define _ieee80211_find_logically_deleted_node(nt, macaddr, bssid, dbgid) \
    _ieee80211_find_logically_deleted_node_debug(nt, macaddr, bssid, dbgid, __func__, __LINE__, __FILE__)
...
#else
#define ieee80211_vap_find_node(_vap, _mac, id)     \
    ieee80211_find_node(&(_vap)->iv_ic->ic_sta, _mac, id)
#endif
...
#define _ieee80211_find_node(nt, mac, id) _ieee80211_find_node_debug(nt, mac, id, __func__, __LINE__, __FILE__)

...
enum {
    ...
    IEEE80211_SUBELEMID_NEIGHBORREPORT_TSF = 1,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_COUNTRY = 2,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_PREFERENCE = 3,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_TERM_DUR = 4,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_BEARING = 5,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_WBC = 6,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_MEASREPORT = 39,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_HTCAP = 45,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_HTOP = 61,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_SEC_CHAN = 62,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_PILOT = 66,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_RM_CAP = 70,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_MBSSID = 71,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_VHTCAP = 191,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_VHTOP = 192,
    IEEE80211_SUBELEMID_NEIGHBORREPORT_VENDOR = 221,
};
...
/* FIXED_RRM_BCNRPT_LEN does not include sub elements*/
#define FIXED_BCNRPT_LEN sizeof(struct ieee80211_beacon_report) - 1
...
#define NEIGHBOR_REPORT_FIXED_LEN 13
...
typedef struct ieee80211_rrm
{
    ...
    u_int8_t                            rrm_macaddr[QDF_MAC_ADDR_SIZE];    /* MAC address */
#if UMAC_SUPPORT_RRM_DEBUG
    u_int32_t                           rrm_dbg_lvl;
#endif
    u_int8_t                            rrm_app_filter;
...
/* Set filter to send RRM packets to user app */
...
static inline int ieee80211_set_rrmfilter(wlan_if_t vap, int val)
{
    return EOK;
}

...
__adf_net_start_tx(struct sk_buff  *skb, struct net_device  *netdev)
{
    ...
    if(unlikely((skb->len <= ETH_HLEN))) {
        qdf_nofl_info("ADF_NET:Bad skb len %d\n", skb->len);
...
qdf_export_symbol(__adf_net_get_vlantag);
...
qdf_export_symbol(__adf_net_get_vlanvid);
...
{
    qdf_nofl_info(" ADF_NET_IOCTL_SUPPORT is not On \n");
...
qdf_export_symbol(__adf_net_create_wifidev);
                        ...
                        adf_net_dev_info_t     *info, void          *vap_cfg)
{
    ...
    if(!is_valid_ether_addr(info->dev_addr)){
        qdf_nofl_info("ADF_NET:invalid MAC address\n");
        error = EINVAL;
    }
...
qdf_export_symbol(__adf_net_create_vapdev);
...
qdf_export_symbol(__adf_net_create_ethdev);
/**
...
qdf_export_symbol(__adf_net_delete_dev);
...
qdf_export_symbol(__adf_net_dev_exist_by_name);
...
qdf_export_symbol(__adf_net_indicate_packet);
...
__adf_net_dev_tx(adf_net_handle_t hdl, struct sk_buff  *skb)
{
    ...
    if(unlikely(!netdev)){
        qdf_nofl_info("ADF_NET:netdev not found\n");
        adf_os_assert(0);
    }
...
qdf_export_symbol(__adf_net_dev_tx);
...
qdf_export_symbol(__adf_net_dev_open);
...
qdf_export_symbol(__adf_net_dev_close);
...
qdf_export_symbol(__adf_net_ifname);
...
qdf_export_symbol(__adf_net_fw_mgmt_to_app);
...
qdf_export_symbol(__adf_net_send_wireless_event);
...
qdf_export_symbol(__adf_net_indicate_vlanpkt);
...
qdf_export_symbol(__adf_net_new_wlanunit);
...
qdf_export_symbol(__adf_net_alloc_wlanunit);
...
qdf_export_symbol(__adf_net_delete_wlanunit);
...
qdf_export_symbol(__adf_net_ifc_name2unit);
...
qdf_export_symbol(__adf_net_free_wlanunit);
...
qdf_export_symbol(__adf_net_register_wpscb);
...
qdf_export_symbol(__adf_net_unregister_wpscb);
...
qdf_export_symbol(__adf_net_poll_schedule);
...
qdf_export_symbol(__adf_net_poll_schedule_cpu);
...
qdf_export_symbol(__adf_net_register_drv);
...
qdf_export_symbol(__adf_net_unregister_drv);

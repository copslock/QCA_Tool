...
qdf_export_symbol(__adf_mempool_init);
qdf_export_symbol(__adf_mempool_destroy);
qdf_export_symbol(__adf_mempool_alloc);
qdf_export_symbol(__adf_mempool_free);

qdf_export_symbol(adf_os_mem_alloc_outline);
qdf_export_symbol(adf_os_mem_free_outline);
qdf_export_symbol(adf_os_mem_zero_outline);

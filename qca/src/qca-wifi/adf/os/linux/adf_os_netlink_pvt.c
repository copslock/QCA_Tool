...
/* exported symbols */
qdf_export_symbol(__adf_netlink_create);
qdf_export_symbol(__adf_netlink_delete);
qdf_export_symbol(__adf_netlink_unicast);
qdf_export_symbol(__adf_netlink_broadcast);
qdf_export_symbol(__adf_netlink_alloc);

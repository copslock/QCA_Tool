...
__adf_nbuf_alloc(adf_os_device_t osdev, size_t size, int reserve, int align, int prio)
{
    ...
    if (!skb) {
        if (printk_ratelimit()) {
            qdf_nofl_info("ERROR:NBUF alloc failed\n");
        }
        return NULL;
    }
    ...
    adf_os_device_t osdev, adf_nbuf_t buf, adf_os_dma_dir_t dir)
{
    ...
    if (0 ==  NBUF_MAPPED_PADDR_LO(buf)) {
        qdf_nofl_info("ERROR: NBUF mapped physical address is NULL\n");
        return;
    }
...
__adf_nbuf_set_rx_cksum(struct sk_buff *skb, adf_nbuf_rx_cksum_t *cksum)
{
    ...
    case ADF_NBUF_RX_CKSUM_TCP_UDP_HW:
        ...
        break;
    default:
        qdf_nofl_info("ADF_NET:Unknown checksum type\n");
        adf_os_assert(0);
...
qdf_export_symbol(__adf_nbuf_alloc);
qdf_export_symbol(__adf_nbuf_free);
qdf_export_symbol(__adf_nbuf_ref);
qdf_export_symbol(__adf_nbuf_shared);
qdf_export_symbol(__adf_nbuf_frag_info);
qdf_export_symbol(__adf_nbuf_dmamap_create);
qdf_export_symbol(__adf_nbuf_dmamap_destroy);
qdf_export_symbol(__adf_nbuf_map);
qdf_export_symbol(__adf_nbuf_unmap);
qdf_export_symbol(__adf_nbuf_map_nbytes);
qdf_export_symbol(__adf_nbuf_unmap_nbytes);
qdf_export_symbol(__adf_nbuf_map_single);
qdf_export_symbol(__adf_nbuf_map_nbytes_single);
qdf_export_symbol(__adf_nbuf_unmap_single);
qdf_export_symbol(__adf_nbuf_unmap_nbytes_single);
qdf_export_symbol(__adf_nbuf_dmamap_info);
qdf_export_symbol(__adf_nbuf_set_rx_cksum);
qdf_export_symbol(__adf_nbuf_get_tx_cksum);
qdf_export_symbol(__adf_nbuf_get_vlan_info);
qdf_export_symbol(__adf_nbuf_get_tid);
qdf_export_symbol(__adf_nbuf_dmamap_set_cb);
qdf_export_symbol(__adf_nbuf_get_frag_size);
qdf_export_symbol(__adf_nbuf_frag_map);

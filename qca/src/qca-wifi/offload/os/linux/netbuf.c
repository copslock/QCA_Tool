...
qdf_export_symbol(a_netbuf_to_data);
qdf_export_symbol(a_netbuf_put);
qdf_export_symbol(a_netbuf_pull);
qdf_export_symbol(a_netbuf_alloc);
qdf_export_symbol(a_netbuf_free);
#endif

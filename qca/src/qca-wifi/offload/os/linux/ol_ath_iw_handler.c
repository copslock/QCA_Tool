...
static const struct iw_priv_args ol_ath_iw_priv_args[] = {
   ...
   */
    ...
    */
    ...
    { ATH_IOCTL_SETHWADDR,
        IW_PRIV_TYPE_CHAR | ((QDF_MAC_ADDR_SIZE * 3) - 1), 0,  "setHwaddr" },
    { ATH_IOCTL_GETHWADDR,
        0, IW_PRIV_TYPE_CHAR | ((QDF_MAC_ADDR_SIZE * 3) - 1),  "getHwaddr" },
    ...
    */
    ...
    { OL_ATH_IOCTL_GET_FC_PEER_STATS,
        IW_PRIV_TYPE_CHAR | ((QDF_MAC_ADDR_SIZE * 3) - 1), 0,  "fc_peer_stats" },
...
#if DBDC_REPEATER_SUPPORT
    { OL_ATH_PARAM_SAME_SSID_DISABLE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,    "samessid_disable" },
    ...
    { OL_ATH_IOCTL_DP_PEER_STATS,
        IW_PRIV_TYPE_CHAR | ((QDF_MAC_ADDR_SIZE * 3) + 1), 0,  "dp_peer_stats" },
...
/*  pdev stats timer */
    ...
    { OL_ATH_PARAM_WIFI_DOWN_IND | OL_ATH_PARAM_SHIFT,
    ...
    { OL_ATH_PARAM_WMI_DIS_DUMP | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "set_wmi_dis_dump" },
...
qdf_export_symbol(ol_ath_iw_attach);
...
qdf_export_symbol(ol_ath_iw_detach);

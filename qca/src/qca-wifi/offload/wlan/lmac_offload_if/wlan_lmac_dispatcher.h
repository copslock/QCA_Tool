...
#ifndef _WLAN_LMAC_DISPATCHER_H_
#define _WLAN_LMAC_DISPATCHER_H_
...
#define MAX_GROUP_KEYS 19
#define RE_UL_RESP 20
...
/**
 * wlan_pktlog_set_checksum() - Set the pktlog defs checksum in pl_dev
 * @pdev: PDEV Object
 * @checksum: Checksum received from FW
 *
 * API to set the pktlog defs checksum received from FW to pl_dev
 *
 * Return: None
 */
...
#endif /* _WLAN_LMAC_DISPATCHER_H_ */

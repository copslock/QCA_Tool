...
#if defined(QCA_LOWMEM_PLATFORM) || defined(CONFIG_WIFI_EMULATION_WIFI_3_0)
/*
...
/*
 * ast flow override configuration
 * Bit 0 - Hi Prio Flow
 * Bit 1 - Low Prio Flow
 * Bit 2 - UDP Flow
 * Bit 3 - Non UDP Flow
 */
#define CFG_TGT_AST_VALID_MASK    0x1
#define CFG_TGT_AST_0_FLOW_MASK    0x4
#define CFG_TGT_AST_1_FLOW_MASK    0x8
#define CFG_TGT_AST_2_FLOW_MASK    0x1
#define CFG_TGT_AST_3_FLOW_MASK    0x2
#define CFG_TGT_AST_TID_HIGH_MASK    0xFF
#define CFG_TGT_AST_TID_LOW_MASK    0xFF

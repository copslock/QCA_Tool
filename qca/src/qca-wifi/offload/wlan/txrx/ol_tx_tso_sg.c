   ...
   void *vdev_handle)
{
    ...
    qdf_warn("TSO SG TX Pkts       : %u\n", pdev->pdev_stats.tso_stats.num_tso_pkts.num);
    qdf_warn("TSO SG TX Bytes      : %llu\n", pdev->pdev_stats.tso_stats.num_tso_pkts.bytes);
    qdf_warn("TSO SG Dropped Pkts  : %u\n", pdev->pdev_stats.tso_stats.dropped_host.num);
    qdf_warn("TSO SG Dropped Bytes : %llu\n", pdev->pdev_stats.tso_stats.dropped_host.bytes);
...
ol_tx_rst_tso_stats(void *vdev_handle)
{
    ...
    pdev->pdev_stats.tso_stats.num_tso_pkts.num = 0;
    pdev->pdev_stats.tso_stats.num_tso_pkts.bytes = 0;
    pdev->pdev_stats.tso_stats.dropped_host.num = 0;
    pdev->pdev_stats.tso_stats.dropped_host.bytes = 0;
    qdf_warn("tso_stats %u %llu \n", pdev->pdev_stats.tso_stats.num_tso_pkts.num,
        pdev->pdev_stats.tso_stats.num_tso_pkts.bytes);
}
...
ol_tx_tso_sg_process_skb(ol_txrx_vdev_handle vdev,qdf_nbuf_t msdu)
{
    ...
    TXRX_VDEV_STATS_MSDU_INCR((struct ol_txrx_vdev_t *)vdev, tso_stats.num_tso_pkts, msdu);

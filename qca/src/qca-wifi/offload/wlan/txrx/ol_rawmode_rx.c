/* Copyright (c) 2014, 2017-2018, 2020 Qualcomm Innovation Center, Inc.
 * All Rights Reserved
    ...
    qdf_nbuf_t nbuf_list)
{
	...
	vdev->osif_rsim_rx_decap(vdev->osif_vdev, &deliver_list_head, &deliver_list_tail, peer->mac_addr.raw);
	if (!deliver_list_head) {
	    return;
	}
    }

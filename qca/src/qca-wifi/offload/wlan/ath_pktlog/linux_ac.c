/*
* Copyright (c) 2012, 2019 Qualcomm Innovation Center, Inc.
* All Rights Reserved.
...
void ol_pl_set_checksum(ol_ath_softc_net80211_handle scn, uint32_t checksum)
{
...
qdf_export_symbol (pktlog_disable_adapter_logging);
...
qdf_export_symbol (pktlog_alloc_buf);
...
qdf_export_symbol (pktlog_release_buf);
#endif

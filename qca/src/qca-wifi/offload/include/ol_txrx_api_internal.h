...
QDF_STATUS
ol_print_lro_stats(struct cdp_soc_t *soc, uint8_t vdev_id);

QDF_STATUS
ol_reset_lro_stats(struct cdp_soc_t *soc, uint8_t vdev_id);
...
extern int ol_txrx_get_nwifi_mode(struct cdp_soc_t *soc, uint8_t vdev_id);

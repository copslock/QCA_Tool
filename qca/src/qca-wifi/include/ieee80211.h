...
#define IEEE80211_IS_HTC_PRESENT(_frame) ((_frame)->i_fc[1] & IEEE80211_FC1_ORDER)
...
#if ATH_SUPPORT_UORA
#define IEEE80211_UORA_LENGTH 2
#endif
...
#if ATH_SUPPORT_UORA
struct ieee80211_ie_uora {
    u_int8_t                uora_id;                /* IEEE80211_ELEMID */
    u_int8_t                uora_len;               /* length in bytes */
    u_int8_t                uora_id_ext;            /* Element ID extension */
    u_int8_t                uora_ocwrange;               /* EOCWmin/EOCWmax field
                                                     * B0-B2: EOCWmin
                                                     * B3-B5: EOCWmax
                                                     * B6-B7: Reserved */
} __packed;
...
#define IEEE80211_ACTION_CAT_FAST_BSS_TRNST       6   /* Fast bss transition action frame */
...
#define IEEE80211_HE_6GBANDCAP_SMPOWERSAVE_MASK     0x0600 /* SM capabitlity bitmask */
#define IEEE80211_HE_6GBANDCAP_SMPOWERSAVE_S        9
#define IEEE80211_SMPOWERSAVE_STATIC                0x0 /* Capable of SM Power Save (Static) */
#define IEEE80211_SMPOWERSAVE_DYNAMIC               0x1 /* Capable of SM Power Save (Dynamic) */
#define IEEE80211_SMPOWERSAVE_DISABLED              0x3 /* SM enabled, no SM Power Save */
...
enum {
    ...
    IEEE80211_ELEMID_RESERVED_49      = 49,
    IEEE80211_ELEMID_XRATES           = 50,
    IEEE80211_ELEMID_AP_CHAN_RPT      = 51,
    IEEE80211_ELEMID_NEIGHBOR_RPT     = 52,
    ...
    IEEE80211_ELEMID_DSE_REG_LOCATION = 58,
    ...
    IEEE80211_ELEMID_BSS_AVG_ACCESS_DELAY = 63,
    IEEE80211_ELEMID_ANTENNA          = 64,
    IEEE80211_ELEMID_RSNI             = 65,
    IEEE80211_ELEMID_MESUREMENT_PILOT_TX = 66,
    IEEE80211_ELEMID_BSS_ADMISSION_CAP = 67,
#ifndef ATH_SUPPORT_WAPI
    IEEE80211_ELEMID_BSS_AC_ACCESS_DELAY = 68, /* ID assigned to this IE in spec */
#endif
    IEEE80211_ELEMID_WAPI              = 68,   /* IE for WAPI, colliding with element ID of BSS_AC_ACCESS_DELAY */
    ...
    IEEE80211_ELEMID_RIC_DESCRIPTOR   = 75,
    IEEE80211_ELEMID_MMIE             = 76,   /* 802.11w Management MIC IE */
    IEEE80211_ELEMID_EVENT_REQUEST    = 78,
    IEEE80211_ELEMID_EVENT_REPORT     = 79,
    IEEE80211_ELEMID_DIAG_REQUEST     = 80, /* Diagnostic Request */
    IEEE80211_ELEMID_DIAG_REPORT      = 81, /* Diagnostic Report */
    ...
    IEEE80211_ELEMID_CHANNEL_USAGE    = 97,
    IEEE80211_ELEMID_TIME_ZONE        = 98,
    IEEE80211_ELEMID_INTERWORKING     = 107,
    IEEE80211_ELEMID_ADVERTISEMENT_PROTO = 108,
    ...
    IEEE80211_ELEMID_MESH_CHANSWITCH_PARAM = 118,
    IEEE80211_ELEMID_MESH_AWAKE_WINDOW = 119,
    IEEE80211_ELEMID_BEACON_TIMING    = 120,
    IEEE80211_ELEMID_MCCAOP_ADV       = 123, /* MCCAOP Advertisement IE */
    IEEE80211_ELEMID_XCAPS            = 127,
    IEEE80211_ELEMID_RESERVED_133     = 133,
    IEEE80211_ELEMID_RESERVED_134     = 134,
    IEEE80211_ELEMID_RESERVED_135     = 135,
    IEEE80211_ELEMID_RESERVED_136     = 136,
    IEEE80211_ELEMID_DMG_CAP          = 148,
    IEEE80211_ELEMID_TPC              = 150,
    IEEE80211_ELEMID_DMG_OPERATION    = 151,
    IEEE80211_ELEMID_CCKM             = 156,
    IEEE80211_ELEMID_MULTIBAND        = 158,
    IEEE80211_ELEMID_RELAY_CAP        = 167,
    IEEE80211_ELEMID_MULTIPLE_MAC_SUB = 170,
    IEEE80211_ELEMID_MCCAOP_ADV_OVERVIEW = 174, /* MCCAOP Advertisement Overview IE */
    IEEE80211_ELEMID_QMF_POLICY       = 181,
    IEEE80211_ELEMID_QLOAD_REPORT     = 186,
    IEEE80211_ELEMID_HCCA_TXOP_UPD_CNT = 187, /* HCCA TXOP Update Count IE */
    IEEE80211_ELEMID_ANTENNA_SECT_ID_PAT = 190, /* Antenna Sector ID Pattern */
    ...
    IEEE80211_ELEMID_S1G_OPENLOOP_LINK_MARGIN = 207, /* S1G Open loop Link Margin Index */
    IEEE80211_ELEMID_RPS              = 208,
    IEEE80211_ELEMID_PAGE_SLICE       =209,
    IEEE80211_ELEMID_AID_RESPONSE     = 211,
    IEEE80211_ELEMID_S1G_SECT_OP      = 212, /* S1G Sector Operation IE */
    IEEE80211_ELEMID_SHORT_BEACON_INTVAL = 214,
    IEEE80211_ELEMID_CHANGE_SEQ       = 215,
    IEEE80211_ELEMID_TWT              = 216,
    IEEE80211_ELEMID_S1G_CAP          = 217,
    IEEE80211_ELEMID_VENDOR           = 221,  /* vendor private */
    IEEE80211_ELEMID_TSF_TIMER_ACC    = 223, /* TSF Timer Accuracy */
    IEEE80211_ELEMID_S1G_RELAY        = 224,
    IEEE80211_ELEMID_S1G_RELAY_ACTIVATION = 224, /* ID collision in spec, with S1G Relay IE */
    IEEE80211_ELEMID_S1G_RELAY_DISCOVREY = 226,
    IEEE80211_ELEMID_SEC_GRP_ID_LIST  = 231, /* Sectorised Group ID list */
    IEEE80211_ELEMID_S1G_OP           = 232,
    IEEE80211_ELEMID_HEADER_COMPRESSION = 233,
    ...
    IEEE80211_ELEMID_DIFF_INIT_LNK_SETUP = 241, /* Differentiated Initial Link Setup IE */
    IEEE80211_ELEMID_RSNX             = 244,
    IEEE80211_ELEMID_EXTN             = 255,
};

/* Vendor-specific HT Capabilities and Operation
 * Used as OUI TYPES
 */
enum {
...
enum {
    ...
    IEEE80211_ELEMID_EXT_FILS_IP_ADDRRANGE_ASSIGN = 6,
    IEEE80211_ELEMID_EXT_KEY_DELIVERY         =  7,
    IEEE80211_ELEMID_EXT_ESP_ELEMID_EXTENSION = 11,
    IEEE80211_ELEMID_EXT_FILS_PUB_KEY         = 12,
    IEEE80211_ELEMID_EXT_FUTURE_CHANNEL_GUIDE = 14,
    IEEE80211_ELEMID_EXT_SERVICE_HINT         = 15,
    IEEE80211_ELEMID_EXT_SERVICE_HASH         = 16,
    IEEE80211_ELEMID_EXT_CDMG_CAP             = 17,
    IEEE80211_ELEMID_EXT_EXTENDED_CLUSTER_RPT = 22,
    IEEE80211_ELEMID_EXT_CMMG_CAP             = 27,
    IEEE80211_ELEMID_EXT_CMMG_OP              = 28,
    IEEE80211_ELEMID_EXT_OWE_DH_PARAM         = 32,
    IEEE80211_ELEMID_EXT_MAX_CHAN_SWITCH_TIME = 34,
    IEEE80211_ELEMID_EXT_GLK_GCR_PARAM_SET    = 34, /* ID assined in spec, collides with MAX_CHAN_SWITCH_TIME */
    IEEE80211_ELEMID_EXT_HECAP                = 35,
    IEEE80211_ELEMID_EXT_HEOP                 = 36,
    IEEE80211_ELEMID_EXT_UORA_PARAM           = 37,
    IEEE80211_ELEMID_EXT_SRP                  = 39,
    IEEE80211_ELEMID_EXT_NDP_FEEDBACK_REPORT_PARAM = 41,
    IEEE80211_ELEMID_EXT_BSSCOLOR_CHG         = 42,
    IEEE80211_ELEMID_EXT_ESS_REPORT           = 45,
    IEEE80211_ELEMID_EXT_HE_BSS_LOAD          = 47,
    IEEE80211_ELEMID_EXT_SHORT_SSID           = 58,
    IEEE80211_ELEMID_EXT_6G_HECAP             = 59,
};
...
#define IEEE80211_BSS_MEMBERSHIP_SELECTOR_SAE_H2E_ONLY 123
...
struct ieee80211_generic_capability_ie {
    u_int8_t generic_capabilities[1]; /* Each bit in this array is used to
                                       * represent a proprietary capability of
                                       * the STA advertising this IE. We
                                       * can extend the size of this array
                                       * in future to include more capabilities.
                                       * The receiver should be able to get the
                                       * array size by removing the header length
                                       * from IE length and it should check
                                       * whether the capability it is refering
                                       * to is within this array bound.
                                       */
} __packed;
 ...
 * R     : Coding Rate
 * NDBPS = NSD*NBPSCS*R
 * Ex    : NDBPS for 20MHz, BPSK, MCS 0 is
 * NDBPS(20 MHz, BPSK, MCS0) = 234*1*(1/2) = 117
 *
 * Note: The NDBPS is used to calculate data rate using following
 * eqn   Data Rate = (NDBPS*NSS)/(SymbolDurn+GI).
 *       Data Rate = (117*1)/(12.8+0.8) = 8.6 Mbps
 */
#define IEEE80211_HE_6GHZ_RATE_LOW_THRES   8600   /* HE MCS0 NSS1 rate in Kbps*/
#define IEEE80211_HE_6GHZ_RATE_HIGH_THRES  25800  /* HE MCS2 NSS1 rate in Kbps*/
#define IEEE80211_HE_6GHZ_NON_HT_RATE      6000
...
#define QCA_OUI_GENERIC_SUBTYPE_1   0x01 /* This subtype is used for adding the
                                          * capabilities supported by transmitter
                                          * (ex. restricted 80P80 support).
                                          */
#define QCA_OUI_GENERIC_VERSION_1   0x01 /* This has the version number for
                                          * generic subtype.
                                          */
...
#define IEEE80211_SELF_NON_SRG_OBSS_PD_THRESHOLD        0x80
#define IEEE80211_SELF_NON_SRG_OBSS_PD_ENABLE           0
#define IEEE80211_SELF_SRG_OBSS_PD_THRESHOLD            0x80
#define IEEE80211_SELF_SRG_OBSS_PD_ENABLE               0
...
#define IEEE80211_EXTCAPIE_BEACON_PROTECTION  0x10 /* bit-84 Beacon Protection */
...
/* coex management action frame identifier */
#define IEEE80211_ACTION_BSS_COEX_FRAME 0
...
#define IEEE80211_VHTCAP_MAX_MPDU_LEN_MASK     0x00000003 /* A-MSDU Length Mask */
...
#define IEEE80211_HE_HIGHER_MCS_MAP             0xff0000
#define IEEE80211_HE_HIGHER_MCS_L80             16
#define IEEE80211_HE_HIGHER_MCS_G80             8

#define IEEE80211_HE_MCS_12_13_SUPP_L80         6
#define IEEE80211_HE_MCS_12_13_SUPP_G80         7
...
/* HE Rate */
#define IEEE80211_HE_MCS_12_13_IDX_MAX        13   /* Supported MCS 12/13 idx range  0 -13 */
...
#define SR_GET_FIELD(_v, _f)   \
       (((_v) & (_f##_MASK)) >> (_f##_LSB))

#define SR_SET_FIELD(_var, _v, _f)     \
       do {    \
               (_var) &= ~(_f##_MASK); \
               (_var) |= (((_v) << (_f##_LSB)) & (_f##_MASK)); \
       } while (0)

/* SRG and non-SRG based OBSS PD */
#define SELF_OBSS_PD_ENABLE      1
#define SELF_OBSS_PD_LOWER_THRESH 0
#define SELF_OBSS_PD_UPPER_THRESH 255

/* Non-SRG based OBSS PD Spatial Reuse */
#define SELF_NON_SRG_OBSS_PD_ENABLE_LSB  31
#define SELF_NON_SRG_OBSS_PD_ENABLE_MASK (1 << SELF_NON_SRG_OBSS_PD_ENABLE_LSB)

#define SELF_NON_SRG_OBSS_PD_THRESH_LSB  0
#define SELF_NON_SRG_OBSS_PD_THRESH_MASK 0x000000FF

/* SRG based OBSS PD Spatial Reuse */
#define SELF_SRG_OBSS_PD_ENABLE_LSB  30
#define SELF_SRG_OBSS_PD_ENABLE_MASK (1 << SELF_SRG_OBSS_PD_ENABLE_LSB)

#define SELF_SRG_OBSS_PD_THRESH_LSB  8
#define SELF_SRG_OBSS_PD_THRESH_MASK 0x0000FF00

#define GET_SELF_OBSS_PD_THRESH(type, _var) \
	SR_GET_FIELD(_var, SELF_##type##_OBSS_PD_THRESH)

#define SET_SELF_OBSS_PD_THRESH(type, _var, _v) \
	SR_SET_FIELD(_var, _v, SELF_##type##_OBSS_PD_THRESH)

#define GET_SELF_OBSS_PD_ENABLE(type, _var) \
	SR_GET_FIELD(_var, SELF_##type##_OBSS_PD_ENABLE)

#define SET_SELF_OBSS_PD_ENABLE(type, _var, _v) \
	SR_SET_FIELD(_var, _v, SELF_##type##_OBSS_PD_ENABLE)
...
#define HECAP_6GBYTE_IDX0       0
#define HECAP_6GBYTE_IDX1       1
...
#define IC_HECAP_6G_MINMPDU_STARTSPACING_IDX            0
#define IC_HECAP_6G_MINMPDU_STARTSPACING_BITS           3
#define IC_HECAP_6G_MAXAMPDU_LEN_EXP_IDX                3
#define IC_HECAP_6G_MAXAMPDU_LEN_EXP_BITS               3
#define IC_HECAP_6G_MAXMPDU_LEN_IDX                     6
#define IC_HECAP_6G_MAXMPDU_LEN_BITS                    3
#define IC_HECAP_6G_SMPS_IDX                            9
#define IC_HECAP_6G_SMPS_BITS                           2
#define IC_HECAP_6G_RD_RESP_IDX                         11
#define IC_HECAP_6G_RD_RESP_BITS                        1
#define IC_HECAP_6G_RX_ANT_PATTERN_CONS_IDX             12
#define IC_HECAP_6G_RX_ANT_PATTERN_CONS_BITS            1
#define IC_HECAP_6G_TX_ANT_PATTERN_CONS_IDX             13
#define IC_HECAP_6G_TX_ANT_PATTERN_CONS_BITS            1

#define HECAP_6G_MINMPDU_START_SPACING_GET_FROM_IC(he_6g_cap)           \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_MINMPDU_STARTSPACING_IDX,    \
        IC_HECAP_6G_MINMPDU_STARTSPACING_BITS)
#define HECAP_6G_MINMPDU_START_SPACING_SET_TO_IC(he_6g_cap, value)      \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_MINMPDU_STARTSPACING_IDX,    \
        IC_HECAP_6G_MINMPDU_STARTSPACING_BITS, value)

#define HECAP_6G_MAXAMPDU_LEN_EXP_GET_FROM_IC(he_6g_cap)                \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_MAXAMPDU_LEN_EXP_IDX,        \
        IC_HECAP_6G_MAXAMPDU_LEN_EXP_BITS)
#define HECAP_6G_MAXAMPDU_LEN_EXP_SET_TO_IC(he_6g_cap, value)           \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_MAXAMPDU_LEN_EXP_IDX,        \
        IC_HECAP_6G_MAXAMPDU_LEN_EXP_BITS, value)

#define HECAP_6G_MAXMPDU_LEN_GET_FROM_IC(he_6g_cap)                     \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_MAXMPDU_LEN_IDX,             \
        IC_HECAP_6G_MAXMPDU_LEN_BITS)
#define HECAP_6G_MAXMPDU_LEN_SET_TO_IC(he_6g_cap, value)                \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_MAXMPDU_LEN_IDX,             \
        IC_HECAP_6G_MAXMPDU_LEN_BITS, value)

#define HECAP_6G_SMPS_GET_FROM_IC(he_6g_cap)                            \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_SMPS_IDX,                    \
        IC_HECAP_6G_SMPS_BITS)
#define HECAP_6G_SMPS_SET_TO_IC(he_6g_cap, value)                       \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_SMPS_IDX,                    \
        IC_HECAP_6G_SMPS_BITS, value)

#define HECAP_6G_RD_RESP_GET_FROM_IC(he_6g_cap)                         \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_RD_RESP_IDX,                 \
        IC_HECAP_6G_RD_RESP_BITS)
#define HECAP_6G_RD_RESP_SET_TO_IC(he_6g_cap, value)                    \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_RD_RESP_IDX,                 \
        IC_HECAP_6G_RD_RESP_BITS, value)

#define HECAP_6G_RXANTENNA_PATTERN_CONS_GET_FROM_IC(he_6g_cap)          \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_RX_ANT_PATTERN_CONS_IDX,     \
        IC_HECAP_6G_RX_ANT_PATTERN_CONS_BITS)
#define HECAP_6G_RXANTENNA_PATTERN_CONS_SET_TO_IC(he_6g_cap, value)     \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_RX_ANT_PATTERN_CONS_IDX,     \
        IC_HECAP_6G_RX_ANT_PATTERN_CONS_BITS, value)

#define HECAP_6G_TXANTENNA_PATTERN_CONS_GET_FROM_IC(he_6g_cap)          \
        HE_GET_BITS(he_6g_cap, IC_HECAP_6G_TX_ANT_PATTERN_CONS_IDX,     \
        IC_HECAP_6G_TX_ANT_PATTERN_CONS_BITS)
#define HECAP_6G_TXANTENNA_PATTERN_CONS_SET_TO_IC(he_6g_cap, value)     \
        HE_SET_BITS(he_6g_cap, IC_HECAP_6G_TX_ANT_PATTERN_CONS_IDX,     \
        IC_HECAP_6G_TX_ANT_PATTERN_CONS_BITS, value)

#define HECAP_6G_MINMPDU_START_SPACING_IDX              0
#define HECAP_6G_MINMPDU_START_SPACING_BITS             3
#define HECAP_6G_MAXAMPDU_LEN_EXP_IDX                   3
#define HECAP_6G_MAXAMPDU_LEN_EXP_BITS                  3
#define HECAP_6G_MAXMPDU_LEN_IDX                        6
#define HECAP_6G_MAXMPDU_LEN_BITS                       3
#define HECAP_6G_SMPS_IDX                               1
#define HECAP_6G_SMPS_BITS                              2
#define HECAP_6G_RD_RESP_IDX                            3
#define HECAP_6G_RD_RESP_BITS                           1
#define HECAP_6G_RXANTENNA_PATTERN_CONS_IDX             4
#define HECAP_6G_RXANTENNA_PATTERN_CONS_BITS            1
#define HECAP_6G_TXANTENNA_PATTERN_CONS_IDX             5
#define HECAP_6G_TXANTENNA_PATTERN_CONS_BITS            1

#define HECAP_6G_MINMPDU_START_SPACING_GET_FROM_IE(hecap_6g)            \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MINMPDU_START_SPACING_IDX,                             \
        HECAP_6G_MINMPDU_START_SPACING_BITS)
#define HECAP_6G_MINMPDU_START_SPACING_SET_TO_IE(hecap_6g, value)       \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MINMPDU_START_SPACING_IDX,                             \
        HECAP_6G_MINMPDU_START_SPACING_BITS, value)

#define HECAP_6G_MAXAMPDU_LEN_EXP_GET_FROM_IE(hecap_6g)                 \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MAXAMPDU_LEN_EXP_IDX,                                  \
        HECAP_6G_MAXAMPDU_LEN_EXP_BITS)
#define HECAP_6G_MAXAMPDU_LEN_EXP_SET_TO_IE(hecap_6g, value)            \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MAXAMPDU_LEN_EXP_IDX,                                  \
        HECAP_6G_MAXAMPDU_LEN_EXP_BITS, value)

#define HECAP_6G_MAXMPDU_LEN_GET_FROM_IE(hecap_6g)                      \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MAXMPDU_LEN_IDX,                                       \
        HECAP_6G_MAXMPDU_LEN_BITS)
#define HECAP_6G_MAXMPDU_LEN_SET_TO_IE(hecap_6g, value)                 \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX0],                       \
        HECAP_6G_MAXMPDU_LEN_IDX,                                       \
        HECAP_6G_MAXMPDU_LEN_BITS, value)

#define HECAP_6G_SMPS_GET_FROM_IE(hecap_6g)                             \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_SMPS_IDX,                                              \
        HECAP_6G_SMPS_BITS)
#define HECAP_6G_SMPS_SET_TO_IE(hecap_6g, value)                        \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_SMPS_IDX,                                              \
        HECAP_6G_SMPS_BITS, value)

#define HECAP_6G_RD_RESP_GET_FROM_IE(hecap_6g)                          \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_RD_RESP_IDX,                                           \
        HECAP_6G_RD_RESP_BITS)
#define HECAP_6G_RD_RESP_SET_TO_IE(hecap_6g, value)                     \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_RD_RESP_IDX,                                           \
        HECAP_6G_RD_RESP_BITS, value)

#define HECAP_6G_RXANTENNA_PATTERN_CONS_GET_FROM_IE(hecap_6g)           \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_RXANTENNA_PATTERN_CONS_IDX,                            \
        HECAP_6G_RXANTENNA_PATTERN_CONS_BITS)
#define HECAP_6G_RXANTENNA_PATTERN_CONS_SET_TO_IE(hecap_6g, value)      \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_RXANTENNA_PATTERN_CONS_IDX,                            \
        HECAP_6G_RXANTENNA_PATTERN_CONS_BITS, value)

#define HECAP_6G_TXANTENNA_PATTERN_CONS_GET_FROM_IE(hecap_6g)           \
        hecap_ie_get(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_TXANTENNA_PATTERN_CONS_IDX,                            \
        HECAP_6G_TXANTENNA_PATTERN_CONS_BITS)
#define HECAP_6G_TXANTENNA_PATTERN_CONS_SET_TO_IE(hecap_6g, value)      \
        hecap_ie_set(hecap_6g[HECAP_6GBYTE_IDX1],                       \
        HECAP_6G_TXANTENNA_PATTERN_CONS_IDX,                            \
        HECAP_6G_TXANTENNA_PATTERN_CONS_BITS, value)
...
#define IEEE80211_HE_6GOP_DEFAULT_MIN_RATE  1 /* Default Minimum Rate: 1Mbps */

#define IEEE80211_NON_HT_DUP_BEACON_M             0x1
#define IEEE80211_NON_HT_DUP_BCAST_PROBE_RESP_M   0x2
#define IEEE80211_NON_HT_DUP_FILS_DISCOVERY_M     0x4
#define IEEE80211_NON_HT_DUP_BEACON_S             0
#define IEEE80211_NON_HT_DUP_BCAST_PROBE_RESP_S   1
#define IEEE80211_NON_HT_DUP_FILS_DISCOVERY_S     2
...
#define HE_BF_CONF_DL_OFDMA_BFER_BIT_POS             7
#define HE_BF_CONF_DL_OFDMA_BFER_NUM_BITS            1
...
#define HECAP_6G_BAND_ELEM_SIZE         2
...
#define IEEE80211_HEOP_6GHZ_INFO_PRESENT_MASK   0X00020000 /* B17 */
#define IEEE80211_HEOP_6GHZ_INFO_PRESENT_S      17
...
#define IEEE80211_6G_BANDCAP_MAX_AMPDU_LEN_EXP_MASK         0x0038
#define IEEE80211_6G_BANDCAP_MAX_AMPDU_LEN_EXP_S            3
#define IEEE80211_6G_BANDCAP_MAX_MPDU_LEN_MASK              0x01C0
#define IEEE80211_6G_BANDCAP_MAX_MPDU_LEN_S                 6
#define IEEE80211_6G_BANDCAP_SMPOWERSAVE_MASK               0x0600
#define IEEE80211_6G_BANDCAP_SMPOWERSAVE_S                  9
#define IEEE80211_6G_BANDCAP_RX_ANTENNA_PATTERN_MASK        0x1000
#define IEEE80211_6G_BANDCAP_RX_ANTENNA_PATTERN_S           12
#define IEEE80211_6G_BANDCAP_TX_ANTENNA_PATTERN_MASK        0x2000
#define IEEE80211_6G_BANDCAP_TX_ANTENNA_PATTERN_S           13
...
struct he_op_param {
    ...
    u_int8_t    er_su_disable:1,       /* 242-tone HE ER SU PPDU reception*/
                op_6g_info_present:1,  /* 6GHz Operation Information Present field */
                reserved:6;            /* 1 bit reserved field */
};
...
struct heop_6g_param {
    u_int8_t    primary_channel;       /* HE 6GHz Primary channel number */
    u_int8_t    channel_width:2,       /* HE 6GHz BSS Channel Width */
                duplicate_beacon:1,    /* HE 6GHz Duplicate beacon field */
                control_reserved:5;    /* Reserved bits */
    u_int8_t    chan_cent_freq_seg0;   /* HE 6GHz Channel Centre Frequency Segment 0 */
    u_int8_t    chan_cent_freq_seg1;   /* HE 6GHz Channel Centre Frequency Segment 1 */
    u_int8_t    minimum_rate;          /* HE 6GHz Minimum Rate */
};
...
struct ieee80211_he_handle {
        ...
        u_int8_t                            he6g_bandcap[HECAP_6G_BAND_ELEM_SIZE];
#if SUPPORT_11AX_D3
...
/*
 * 802.11ax HE 6GHz Capability
 */
struct ieee80211_ie_he_6g_bandcap {
        u_int8_t                  elem_id;
        u_int8_t                  elem_len;
        u_int8_t                  elem_id_ext;
        u_int8_t                  he_6g_bandcap[HECAP_6G_BAND_ELEM_SIZE];
} __packed;
...
struct ieee80211_ie_heop {
        ...
        u_int8_t        heop_6g_info[HEOP_6G_INFO_SIZE];
} __packed;
...
#define IEEE80211_ASSOC_MIN_RSSI_DEFAULT -90    /* dBm */
#define IEEE80211_ASSOC_MIN_RSSI_MIN     -90    /* dBm */
#define IEEE80211_ASSOC_MIN_RSSI_MAX     -30    /* dBm */
...
#define NO_CHUNKS_COPY 1
/* struct sta_info_req
 * @len: len
 * @info: userspace data ptr
 * @addr: len addr
 */
typedef struct sta_info_req {
    uint32_t len;
...
/* Enum to select between beacon/FILS Discovery/Bcast Probe resp
 * for non-HT duplicate PPDU transmission.
 */
enum {
    NON_HT_DUP_BEACON = 1,
    NON_HT_DUP_BCAST_PROBE_RESP = 2,
    NON_HT_DUP_FILS_DISCOVERY = 3,
    NON_HT_DUP_MAX = 4,
};
...
typedef struct ieee80211_rnr_bss_params {
#if _BYTE_ORDER == _BIG_ENDIAN
    u_int8_t reserved:1;
    u_int8_t co_located_ap:1;
    u_int8_t probe_resp_20tu_active:1;
    u_int8_t colocated_lower_band_ess:1;
    u_int8_t tx_bssid:1;
    u_int8_t mbssid_set:1;
    u_int8_t same_ssid:1;
    u_int8_t oct_recommended:1;
#else
    u_int8_t oct_recommended:1;
    u_int8_t same_ssid:1;
    u_int8_t mbssid_set:1;
    ...
    u_int8_t reserved:1;
#endif
} __packed ieee80211_rnr_bss_params_t;

typedef struct ieee80211_rnr_tbtt_info_set {
    u_int8_t  tbtt_offset;
    u_int8_t  bssid[IEEE80211_ADDR_LEN];
    u_int32_t short_ssid;
    struct  ieee80211_rnr_bss_params bss_params;
} __packed ieee80211_rnr_tbtt_info_set_t;

#define TBTT_INFO_FIELD_SIZE    12
typedef struct ieee80211_rnr_nbr_ap_info {
#if _BYTE_ORDER == _BIG_ENDIAN
    ...
    u_int8_t  op_class;
    u_int8_t  channel;
    struct ieee80211_rnr_tbtt_info_set tbtt_info[0];
} __packed ieee80211_rnr_nbr_ap_info_t;

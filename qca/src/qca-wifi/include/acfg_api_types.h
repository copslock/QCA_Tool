...
enum acfg_param_vap {
    ...
    /* Enable/Disable selective Legacy Rates for this vap. */
    ACFG_PARAM_DISABLE_SELECTIVE_LEGACY_RATE = IEEE80211_PARAM_DISABLE_SELECTIVE_LEGACY_RATE_FOR_VAP,

    /* Control beacon rate*/
    ACFG_PARAM_MODIFY_BEACON_RATE   = IEEE80211_PARAM_BEACON_RATE_FOR_VAP,

    /* Implicit beamforming */
    ACFG_PARAM_IMPLICITBF           = IEEE80211_PARAM_IMPLICITBF,

    /*Clear optional IEs*/
    ACFG_PARAM_CLR_APPOPT_IE        = IEEE80211_PARAM_CLR_APPOPT_IE,

     /* Control sifs_trigger rate */
    ACFG_PARAM_SIFS_TRIGGER_RATE    = IEEE80211_PARAM_SIFS_TRIGGER_RATE,

    ACFG_PARAM_FT_ENABLE            = IEEE80211_PARAM_FT_ENABLE,
    ACFG_PARAM_SIFS_TRIGGER         = IEEE80211_PARAM_SIFS_TRIGGER,
    ACFG_PARAM_RX_MCSMAP            = IEEE80211_PARAM_HE_RX_MCSMAP,
    ACFG_PARAM_TX_MCSMAP            = IEEE80211_PARAM_HE_TX_MCSMAP,
    ACFG_PARAM_TXPOW                = 558,
    ACFG_PARAM_GET_OPMODE           = 616,
};
...
enum acfg_req_cmd {
    ...
    ACFG_REQ_GET_VAP_NAMES,     /* Get VAP iface names */
...
struct acfg_vap_iface_names {
    uint8_t name[ACFG_MAX_VAPS][ACFG_MAX_IFNAME];
    uint8_t vap_count;
};
...
struct acfg_offchan_hdr {
	...
	uint16_t msg_length;
	uint16_t channel;
	enum wlan_band_id channel_band;
	uint16_t scan_dur;
	uint8_t bw_mode;

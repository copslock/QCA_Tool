...
#ifdef ATH_TX99_DIAG
    struct ieee80211_ath_channel *  (*ath_net80211_find_channel)(struct ath_softc *sc, int ieee, uint16_t des_cfreq2, enum ieee80211_phymode mode);
#endif
...
#ifdef DEBUG
#define ATH_TRACE   qdf_nofl_info("%s[%d]\n", __func__, __LINE__);
#else
#define ATH_TRACE
#endif /* DEBUG */

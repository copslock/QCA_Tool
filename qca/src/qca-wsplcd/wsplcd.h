...
#define MAX_WLAN_CONFIGURATION 24
...
typedef struct apacMapData_t {
    ...
    apacHyfi20MapV2Provisioning_e onboardingType;
    apacHyfi20MapV2IntrigityAlgo_e integrityAlgoType;
    apacHyfi20MapV2EncryptionAlgo_e encryptionAlgotype;

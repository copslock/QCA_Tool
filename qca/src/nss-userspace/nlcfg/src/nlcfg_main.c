...
static struct nlcfg_param family_params[] = {
	...
	NLCFG_PARAMLIST_INIT("family=ipsec", nlcfg_ipsec_params, nlcfg_param_iter_tbl),
	NLCFG_PARAMLIST_INIT("family=gre_redir", nlcfg_gre_redir_params, nlcfg_param_iter_tbl),
	NLCFG_PARAMLIST_INIT("family=capwap", nlcfg_capwap_params, nlcfg_param_iter_tbl),
	NLCFG_PARAMLIST_INIT("family=dtls", nlcfg_dtls_params, nlcfg_param_iter_tbl),
};

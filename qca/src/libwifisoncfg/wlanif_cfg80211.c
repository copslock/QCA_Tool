...
int getMapBssRole_cfg80211(void *ctx, const char *ifName, u_int8_t *mapBssRole) {
    ...
    if ((ret = send_command_get_cfg80211(&(cfgPriv->cfg80211_ctx_qca), ifName,
                                         IEEE80211_PARAM_MAP_BSS_TYPE, &result)) < 0) {
        goto err;
    }
...
static struct wlanif_config_ops wlanif_cfg80211_ops = {
    ...
    .setCFreq2 = setCFreq2_cfg80211,
    .getPrivArgs = getPrivArgs_cfg80211,
    .getACSReport = getACSReport_cfg80211,
    .getCountryCode = getCountryCode_cfg80211,
    .setAcsChanList = setAcsChanList_cfg80211,
    .getMapBssRole = getMapBssRole_cfg80211,
    .setCACTimeout = setCACTimeout_cfg80211,
    .getPhyStats = getPhyStats_cfg80211,
};
